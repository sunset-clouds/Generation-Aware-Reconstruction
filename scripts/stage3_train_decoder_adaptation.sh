...
DATASET_ROOT=${1:?usage: train_decoder_adaptation.sh DATASET_ROOT IMF_CKPT OUT_ROOT}
IMF_CKPT=${2:?usage: train_decoder_adaptation.sh DATASET_ROOT IMF_CKPT OUT_ROOT}
OUT_ROOT=${3:?usage: train_decoder_adaptation.sh DATASET_ROOT IMF_CKPT OUT_ROOT}
