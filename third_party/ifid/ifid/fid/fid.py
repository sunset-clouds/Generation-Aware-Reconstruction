...
Code adapted from TTUR to use PyTorch instead
of Tensorflow
...
FID_WEIGHTS_PATH = os.environ.get(
    "PYTORCH_FID_INCEPTION_CKPT",
    os.path.join("assets", "checkpoints", "pt_inception-2015-12-05-6726825d.pth"),
)
...
def fid_inception_v3():
    ...
    if not os.path.exists(FID_WEIGHTS_PATH):
        raise FileNotFoundError(
            "PyTorch FID Inception checkpoint not found. Set "
            "PYTORCH_FID_INCEPTION_CKPT or place it under assets/checkpoints."
        )
