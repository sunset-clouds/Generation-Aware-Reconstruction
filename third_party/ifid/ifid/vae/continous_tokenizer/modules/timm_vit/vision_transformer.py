...
default_cfgs = {
    ...
    # DINO pretrained -  (no classifier head, for fine-tune only)
    ...
    # DINOv2 pretrained -  (no classifier head, for fine-tune/features only)
    ...
    # DINOv2 pretrained w/ registers -  (no classifier head, for fine-tune/features only)
...
def vit_base_patch32_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    """ViT-Base (ViT-B/32) from original paper ().
...
def vit_base_patch32_384(pretrained: bool = False, **kwargs) -> VisionTransformer:
    """ViT-Base model (ViT-B/32) from original paper ().
...
def vit_base_patch8_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    """ViT-Base (ViT-B/8) from original paper ().
    ImageNet-1k weights fine-tuned from in21k @ 224x224, source 
    """
...
def vit_large_patch32_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    """ViT-Large model (ViT-L/32) from original paper (). No pretrained weights."""
...
def vit_large_patch32_384(pretrained: bool = False, **kwargs) -> VisionTransformer:
    """ViT-Large model (ViT-L/32) from original paper ().
    ImageNet-1k weights fine-tuned from in21k @ 384x384, source 
    """
    model_args = dict(patch_size=32, embed_dim=1024, depth=24, num_heads=16)
    model = _create_vision_transformer(
...
def vit_large_patch16_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    """ViT-Large model (ViT-L/16) from original paper ().
    ImageNet-1k weights fine-tuned from in21k @ 224x224, source 
    """
...
def vit_giant_patch14_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    """ViT-Giant (little-g) model (ViT-g/14) from `Scaling Vision Transformers` - """
    model_args = dict(
...
def vit_gigantic_patch14_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    """ViT-Gigantic (big-G) model (ViT-G/14) from `Scaling Vision Transformers` - """
    model_args = dict(
...
def vit_gigantic_patch14_clip_224(
    ...
    """ViT-bigG model (ViT-G/14) from `Scaling Vision Transformers` - 
    Pretrained weights from CLIP image tower.
    """
    model_args = dict(
        patch_size=14,
...
def eva_large_patch14_196(pretrained: bool = False, **kwargs) -> VisionTransformer:
    """EVA-large model  /via MAE MIM pretrain"""
    model_args = dict(
