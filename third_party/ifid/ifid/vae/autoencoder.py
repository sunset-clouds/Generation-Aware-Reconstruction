...
def _config_path(env_name, default_rel):
    import os
    return os.environ.get(env_name, default_rel)
...
def VAE_SoftVQ(**kwargs):
    return AutoencoderCont(_config_path("SOFTVQ_ROOT", "SoftVQVAE/softvq-l-64"))


def VAE_MAETOK(**kwargs):
    return AutoencoderCont(_config_path("MAETOK_ROOT", "./assets/checkpoints/maetok-b-128"), use_ae=True)
