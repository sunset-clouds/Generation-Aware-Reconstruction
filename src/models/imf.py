"""
improved MeanFlow (iMF) model.

Ported from iMF codebase for standalone operation.
"""
...
def generate(variable, model, rng, n_sample, latent_size, num_classes,
    ...
    Args:
        ...
        latent_size: Size of latent (e.g., 32 for 256px images).
    ...
    """
    x_shape = (n_sample, latent_size, latent_size, 4)
